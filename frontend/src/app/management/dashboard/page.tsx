...
export default function ManagementDashboard() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        {/* Sidebar */}
        <div className="w-[16vw] min-w-[220px]">
          <ManagementSideBar/>
        </div>
        ...
        <main className="flex-1 p-8">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-[#3A3985]">Dashboard</h1>
            <p className="text-[#3499FF] mt-2">
              Welcome, <span className="italic font-semibold">Jane Smith!</span>{" "}
              Here&apos;s a summary of your review tasks
            </p>
          </div>
          ...
          <div className="bg-white shadow rounded-xl p-6 mb-8">
            <h2 className="bg-gradient-to-r from-red-600 to-orange-400 inline-block text-transparent bg-clip-text">
              High Priority Alert
            </h2>
            ...
            <div className="bg-red-50 border-l-4 border-red-500 rounded-lg p-4 flex items-center justify-between mb-4">
              <div>
                <p className="font-semibold text-red-700">
                  PT. Mega Corp Contract - High Risk Clause Detected
                </p>
                <p className="text-sm text-gray-600">
                  AI detected payment clauses that do not meet company standards
                </p>
              </div>
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 rounded-lg p-4 flex items-center justify-between">
              <div>
                <p className="font-semibold text-yellow-700">
                  5 contracts approaching review deadline (24 hours)
                </p>
                <p className="text-sm text-gray-600">
                  Supplier, IT service, and consulting contracts need to be
                  completed
                </p>
              </div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2">
                ...
                <span className="text-gray-900">
                  <span className="font-medium">Approved</span> PT. Tech
                  Solution&apos;s IT service contract.
                </span>
              ...
              <li className="flex items-center gap-2">
                ...
                <span className="text-gray-900">
                  <span className="font-medium">Rejected</span> supplier
                  contract - clause not in accordance.
                </span>
                <span className="ml-auto text-sm text-gray-500">
                  30 mins ago
                </span>
